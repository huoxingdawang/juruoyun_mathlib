...
int main()
{
	...
	jml_matrix* m2=jml_matrix_swap_line		(jml_matrix_copy(m1),0,2);
	jml_matrix* m3=jml_matrix_swap_row		(jml_matrix_copy(m1),0,2);
	jml_matrix* m4=jml_matrix_multiply_line	(jml_matrix_copy(m1),0,2);
	jml_matrix* m5=jml_matrix_multiply_row	(jml_matrix_copy(m1),1,2);
	jml_matrix* m6=jml_matrix_add_line		(jml_matrix_copy(m1),0,1,2);
	jml_matrix* m7=jml_matrix_add_row		(jml_matrix_copy(m1),0,1,2);
	jml_matrix* m8=jml_matrix_toup			(jml_matrix_copy(m1));
